...
'''
思路：贪心 排序
按照生长时间 逆序、种下时间 正序排序，依次累加生长时间，种下时间，如果种下时间超过了生长时间，那么这段时间无法忽略，需要累加到结果里
结果的初始值是第1个种子的种下时间+最后一个种子的生长时间。
...
s = Solution()
print(s.earliestFullBloom(plantTime=[1, 4, 3], growTime=[2, 3, 1]))
