...
> 当nums[0..1]==10 or nums[0..1]==20时，dp[1]为1
经过上面的分析，得到状态转移方程：
dp[i] = dp[i-1]，此时nums[i-1..i]>25 or nums[i-1..i]==10 or nums[i-1..i]==20
...
class Solution:
    def translateNum(self, num: int) -> int:
        ...
        for i in range(2, n):
            ...
            if twoBit == 0:
                return 0
            elif twoBit > 25 or twoBit == 10 or twoBit == 20:  # >25，=10，=20的情况下，只有一种选择，不会对解码数量造成影响
                dp[i] = dp[i - 1]
