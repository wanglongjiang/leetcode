...
- 1717.[删除子字符串的最大得分](medium/1717-maximum-score-from-removing-substrings.py)
- 1762.[能看到海景的建筑物](vip/medium/1762-buildings-with-an-ocean-view.py)
- 2116.[判断一个括号字符串是否有效](medium/2116-check-if-a-parentheses-string-can-be-valid.py)
- 2434.[使用机器人打印字典序最小的字符串](medium/2434-using-a-robot-to-print-the-lexicographically-smallest-string.py)
...
- 1504.[统计全 1 子矩形](medium/1504-count-submatrices-with-all-ones.py)
...
- 2454.[下一个更大元素 IV](hard/2454-next-greater-element-iv.py)
- 2487.[从链表中移除节点](medium/2487-remove-nodes-from-linked-list.py)
...
- 2146.[价格范围内最高排名的 K 样物品](medium/2146-k-highest-ranked-items-within-a-price-range.py)
...
- 2462.[雇佣 K 位工人的总代价](medium/2462-total-cost-to-hire-k-workers.py)
- LCP 56.[信物传送](lcp/56-6UEx57.py)
...
- 862.[和至少为 K 的最短子数组](hard/862-shortest-subarray-with-sum-at-least-k.py)

## 数组 array

- 163.[缺失的区间](vip/easy/163-missing-ranges.py)
- 243.[最短单词距离](vip/easy/243-shortest-word-distance.py)
- 280.[摆动排序](vip/medium/280-wiggle-sort.py)
...
- 2444.[统计定界子数组的数目](hard/2444-count-subarrays-with-fixed-bounds.py)
...
- 1139.[最大的以 1 为边界的正方形](medium/1139-largest-1-bordered-square.py)
...
- 1664.[生成平衡数组的方案数](medium/1664-ways-to-make-a-fair-array.py)
- 1749.[任意子数组和的绝对值的最大值](medium/1749-maximum-absolute-sum-of-any-subarray.py)
...
- 2106.[摘水果](hard/2106-maximum-fruits-harvested-after-at-most-k-steps.py)
...
- 2420.[找到所有好下标](medium/6190-find-all-good-indices.py)
- 2484.[统计回文子序列数目](hard/2484-count-palindromic-subsequences.py)
...
- 2032.[至少在两个数组中出现的值](easy/2032-two-out-of-three.py)
...
- 2442.[反转之后不同整数的数目](medium/2442-count-number-of-distinct-integers-after-reverse-operations.py)
- 2456.[最流行的视频创作者](medium/2456-most-popular-video-creator.py)
- 2491.[划分技能点相等的团队](medium/2491-divide-players-into-teams-of-equal-skill.py)
- 2501.[数组中最长的方波](medium/2501-longest-square-streak-in-an-array.py)
- 2512.[奖励最顶尖的 K 名学生](medium/2512-reward-top-k-students.py)
- LCP 62.[交通枢纽](lcp/62-D9PW8w.py)
...
- 1704.[判断字符串的两半是否相似](easy/1704-determine-if-string-halves-are-alike.py)
- 1737.[满足三条件之一需改变的最少字符数](medium/1737-change-minimum-characters-to-satisfy-one-of-three-conditions.py)
- 1758.[生成交替二进制字符串的最少操作数](easy/1758-minimum-changes-to-make-alternating-binary-string.py)
...
- 250.[统计同值子树](vip/medium/250-count-univalue-subtrees.py)
- 297.[二叉树的序列化与反序列化](hard/297-serialize-and-deserialize-binary-tree.py)
- 429.[N 叉树的层序遍历](medium/429-n-ary-tree-level-order-traversal.py)
...
- 1145.[二叉树着色游戏](medium/1145-binary-tree-coloring-game.py)
...
- 1325.[删除给定值的叶子节点](medium/1325-delete-leaves-with-a-given-value.py)
- 1372.[二叉树中的最长交错路径](medium/1372-longest-zigzag-path-in-a-binary-tree.py)
- 1443.[收集树上所有苹果的最少时间](medium/1443-minimum-time-to-collect-all-apples-in-a-tree.py)
- 1448.[统计二叉树中好节点的数目](medium/1448-count-good-nodes-in-binary-tree.py)
...
- 2265.[统计值等于子树平均值的节点数](medium/2265-count-nodes-equal-to-average-of-subtree.py)
- 2476.[二叉搜索树最近节点查询](medium/2476-closest-nodes-queries-in-a-binary-search-tree.py)
- 2509.[查询树中环的长度](hard/2509-cycle-length-queries-in-a-tree.py)
...
- 2426.[满足不等式的数对数目](hard/2426-number-of-pairs-satisfying-inequality.py)
...
- 743.[网络延迟时间](medium/743-network-delay-time.py)
- 882.[细分图中的可到达节点](hard/882-reachable-nodes-in-subdivided-graph.py)
- 1631.[最小体力消耗路径](medium/1631-path-with-minimum-effort.py)
- 1976.[到达目的地的方案数](medium/1976-number-of-ways-to-arrive-at-destination.py)
...
- 481.[神奇字符串](medium/481-magical-string.py)
- 498.[对角线遍历](medium/498-diagonal-traverse.py)
- 529.[扫雷游戏](medium/529-minesweeper.py)
...
- 1041.[困于环中的机器人](medium/1041-robot-bounded-in-circle.py)
...
- 1668.[最大重复子字符串](easy/1668-maximum-repeating-substring.py)
- 1684.[统计一致字符串的数目](easy/1684-count-the-number-of-consistent-strings.py)
- 1694.[重新格式化电话号码](easy/1694-reformat-phone-number.py)
- 1700.[无法吃午餐的学生数量](easy/1700-number-of-students-unable-to-eat-lunch.py)
...
- 1742.[盒子中小球的最大数量](easy/1742-maximum-number-of-balls-in-a-box.py)
- 1773.[统计匹配检索规则的物品数量](easy/1773-count-items-matching-a-rule.py)
- 1779.[找到最近的有相同 X 或 Y 坐标的点](easy/1779-find-nearest-point-that-has-the-same-x-or-y-coordinate.py)
- 1784.[检查二进制字符串字段](easy/1784-check-if-binary-string-has-at-most-one-segment-of-ones.py)
- 1796.[字符串中第二大的数字](easy/1796-second-largest-digit-in-a-string.py)
- 1800.[最大升序子数组和](easy/1800-maximum-ascending-subarray-sum.py)
- 1805.[字符串中不同整数的数目](easy/1805-number-of-different-integers-in-a-string.py)
- 1860.[增长的内存泄露](medium/1860-incremental-memory-leak.py)
- 1945.[字符串转化后的各位数字之和](easy/1945-sum-of-digits-of-string-after-convert.py)
- 2027.[转换字符串的最少操作次数](easy/2027-minimum-moves-to-convert-string.py)
- 2042.[检查句子中的数字是否递增](easy/2042-check-if-numbers-are-ascending-in-a-sentence.py)
...
- 2452.[距离字典两次编辑以内的单词](medium/2452-words-within-two-edits-of-dictionary.py)
- 2453.[摧毁一系列目标](medium/2453-destroy-sequential-targets.py)
...
- 878.[第 N 个神奇数字](hard/878-nth-magical-number.py)
- 900.[RLE 迭代器](medium/900-rle-iterator.py)
...
- 1889.[装包裹的最小浪费空间](hard/1889-minimum-space-wasted-from-packaging.py)
...
- 2141.[同时运行 N 台电脑的最长时间](hard/2141-maximum-running-time-of-n-computers.py)
...
- 2250.[统计包含每个点的矩形数目](medium/2250-count-number-of-rectangles-containing-each-point.py)
- 2271.[毯子覆盖的最多白色砖块数](medium/2271-maximum-white-tiles-covered-by-a-carpet.py)
- 2448.[使数组相等的最小开销](hard/2448-minimum-cost-to-make-array-equal.py)
- 2468.[根据限制分割消息](hard/2468-split-message-based-on-limit.py)
- 2482.[行和列中一和零的差值](medium/2482-difference-between-ones-and-zeros-in-row-and-column.py)
- 2483.[商店的最少代价](medium/2483-minimum-penalty-for-a-shop.py)
- 2517.[礼盒的最大甜蜜度](medium/2517-maximum-tastiness-of-candy-basket.py)
...
- 891.[子序列宽度之和](hard/891-sum-of-subsequence-widths.py)
...
- 1887.[使数组元素相等的减少操作次数](medium/1887-reduction-operations-to-make-the-array-elements-equal.py)
- 1968.[构造元素不等于两相邻元素平均值的数组](medium/1968-array-with-elements-not-equal-to-average-of-neighbors.py)
- 2037.[使每位学生都有座位的最少移动次数](easy/2037-minimum-number-of-moves-to-seat-everyone.py)
- 2070.[每一个查询的最大美丽值](medium/2070-most-beautiful-item-for-each-query.py)
- 2171.[拿出最少数目的魔法豆](medium/2171-removing-minimum-number-of-magic-beans.py)
...
- 2449.[使数组相似的最少操作次数](hard/2449-minimum-number-of-operations-to-make-arrays-similar.py)
- 2497.[图中最大星和](medium/2497-maximum-star-sum-of-a-graph.py)
- 面试题 16.06.[最小差](interview/16.06.smallest-difference-lcci.py)
...
- 861.[翻转矩阵后的得分](medium/861-score-after-flipping-matrix.py)
...
- 945.[使数组唯一的最小增量](medium/945-minimum-increment-to-make-array-unique.py)
- 976.[三角形的最大周长](三角形的最大周长)
...
- 1090.[受标签影响的最大值](medium/1090-largest-values-from-labels.py)
- 1326.[灌溉花园的最少水龙头数目](hard/1326-minimum-number-of-taps-to-open-to-water-a-garden.py)
...
- 1713.[得到子序列的最少操作次数](hard/1713-minimum-operations-to-make-a-subsequence.py)
- 1775.[通过最少操作次数使数组的和相等](medium/1775-equal-sum-arrays-with-minimum-number-of-operations.py)
- 1785.[构成特定和需要添加的最少元素](medium/1785-minimum-elements-to-add-to-form-a-given-sum.py)
- 1833.[雪糕的最大数量](medium/1833-maximum-ice-cream-bars.py)
- 1874.[两个数组的最小乘积和](vip/medium/1874-minimize-product-sum-of-two-arrays.py)
- 1911.[最大子序列交替和](medium/1911-maximum-alternating-subsequence-sum.py)
...
- 2086.[从房屋收集雨水需要的最少水桶数](medium/2086-minimum-number-of-buckets-required-to-collect-rainwater-from-houses.py)
...
- 2216.[美化数组的最少删除数](medium/2216-minimum-deletions-to-make-array-beautiful.py)
...
- 2419.[按位与最大的最长子数组](medium/6189-longest-subarray-with-maximum-bitwise-and.py)
- 2439.[最小化数组中的最大值](hard/2439-minimize-maximum-of-array.py)
- 2498.[青蛙过河 II](medium/2498-frog-jump-ii.py)
...
- 898.[子数组按位或操作](medium/898-bitwise-ors-of-subarrays.py)
...
- 1738.[找出第 K 大的异或坐标值](medium/1738-find-kth-largest-xor-coordinate-value.py)
- 1812.[判断国际象棋棋盘中一个格子的颜色](easy/1812-determine-color-of-a-chessboard-square.py)
- 1832.[判断句子是否为全字母句](easy/1832-check-if-the-sentence-is-pangram.py)
...
- 2433.[找出前缀异或的原始数组](medium/2433-find-the-original-array-of-prefix-xor.py)
- 2438.[二的幂数组中查询范围内的乘积](medium/2438-range-product-queries-of-powers.py)
...
- 1284.[转化为全零矩阵的最少反转次数](hard/1284-minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix.py)
...
- 2440.[创建价值相同的连通块](hard/2440-create-components-with-same-value.py)
- 2458.[移除子树后的二叉树高度](hard/2458-height-of-binary-tree-after-subtree-removal-queries.py)
- 2467.[树上最大得分和路径](medium/2467-most-profitable-path-in-a-tree.py)
- 2477.[到达首都的最少油耗](medium/2477-minimum-fuel-cost-to-report-to-the-capital.py)
- 2492.[两个城市间路径的最小分数](medium/2492-minimum-score-of-a-path-between-two-cities.py)
- LCS 03.[主题空间](lcs/03-YesdPw.py)
- LCP 67.[装饰树](lcp/67-KnLfVT.py)
...
- 1210.[穿过迷宫的最少移动次数](hard/1210-minimum-moves-to-reach-target-with-rotations.py)
- 1263.[推箱子](hard/1263-minimum-moves-to-move-a-box-to-their-target-location.py)
- 1293.[网格中的最短路径](hard/1293-shortest-path-in-a-grid-with-obstacles-elimination.py)
- 1298.[你能从盒子里获得的最大糖果数](hard/1298-maximum-candies-you-can-get-from-boxes.py)
- 1306.[跳跃游戏 III](medium/1306-jump-game-iii.py)
- 1311.[获取你好友已观看的视频](medium/1311-get-watched-videos-by-your-friends.py)
- 1368.[使网格图至少有一条有效路径的最小代价](hard/1368-minimum-cost-to-make-at-least-one-valid-path-in-a-grid.py)
...
- 2059.[转化数字的最小运算数](medium/2059-minimum-operations-to-convert-number.py)
...
- 2471.[逐层排序二叉树所需的最少操作数目](medium/2471-minimum-number-of-operations-to-sort-a-binary-tree-by-level.py)
...
- 777.[在LR字符串中交换相邻字符](medium/777-swap-adjacent-in-lr-string.py)
...
- 1759.[统计同构子字符串的数目](medium/1759-count-number-of-homogenous-substrings.py)
...
- 2486.[追加字符以获得子序列](medium/2486-append-characters-to-string-to-make-subsequence.py)
- 2516.[每种字符至少取 K 个](medium/2516-take-k-of-each-character-from-left-and-right.py)
...
- 2311.[小于等于 K 的最长二进制子序列](medium/2311-longest-binary-subsequence-less-than-or-equal-to-k.py)
- 2461.[长度为 K 子数组中的最大和](medium/2461-maximum-sum-of-distinct-subarrays-with-length-k.py)
- LCP 68.[美观的花束](lcp/68-1GxJYY.py)
- 面试题 16.17.[连续数列](interview/16.17.contiguous-sequence-lcci.py)
...
- 1140.[石子游戏 II](medium/1140-stone-game-ii.py)
- 1376.[通知所有员工所需的时间](medium/1376-time-needed-to-inform-all-employees.py)
- 2019.[解出数学表达式的学生分数](hard/2019-the-score-of-students-solving-math-expression.py)
- 2400.[恰好移动 k 步到达某一位置的方法数目](medium/2400-number-of-ways-to-reach-a-position-after-exactly-k-steps.py)
...
- 174.[地下城游戏](hard/174-dungeon-game.py)
...
- 790.[多米诺和托米诺平铺](medium/790-domino-and-tromino-tiling.py)
- 799.[香槟塔](medium/799-champagne-tower.py)
- 801.[使序列递增的最小交换次数](hard/801-minimum-swaps-to-make-sequences-increasing.py)
- 808.[分汤](medium/808-soup-servings.py)
- 813.[最大平均值和的分组](medium/813-largest-sum-of-averages.py)
- 823.[带因子的二叉树](medium/823-binary-trees-with-factors.py)
- 894.[所有可能的满二叉树](medium/894-all-possible-full-binary-trees.py)
- 902.[最大为 N 的数字组合](hard/902-numbers-at-most-n-given-digit-set.py)
...
- 940.[不同的子序列 II](hard/940-distinct-subsequences-ii.py)
...
- 1039.[多边形三角剖分的最低得分](medium/1039-minimum-score-triangulation-of-polygon.py)
- 1043.[分隔数组以得到最大和](medium/1043-partition-array-for-maximum-sum.py)
- 1092.[最短公共超序列](hard/1092-shortest-common-supersequence.py)
- 1155.[掷骰子的N种方法](medium/1155-number-of-dice-rolls-with-target-sum.py)
...
- 1312.[让字符串成为回文串的最少插入次数](hard/1312-minimum-insertion-steps-to-make-a-string-palindrome.py)
- 1334.[阈值距离内邻居最少的城市](medium/1334-find-the-city-with-the-smallest-number-of-neighbors-at-a-threshold-distance.py)
- 1335.[工作计划的最低难度](hard/1335-minimum-difficulty-of-a-job-schedule.py)
- 1449.[数位成本和为目标值的最大数字](hard/1449-form-largest-integer-with-digits-that-add-up-to-target.py)
- 1463.[摘樱桃 II](hard/1463-cherry-pickup-ii.py)
- 1478.[安排邮筒](hard/1478-allocate-mailboxes.py)
- 1594.[矩阵的最大非负积](medium/1594-maximum-non-negative-product-in-a-matrix.py)
- 1626.[无矛盾的最佳球队](medium/1626-best-team-with-no-conflicts.py)
- 1641.[统计字典序元音字符串的数目](medium/1641-count-sorted-vowel-strings.py)
- 1769.[移动所有球到每个盒子所需的最小操作数](medium/1769-minimum-number-of-operations-to-move-all-balls-to-each-box.py)
- 1787.[使所有区间的异或结果为零](hard/1787-make-the-xor-of-all-segments-equal-to-zero.py)
- 1799.[N 次操作后的最大分数和](hard/1799-maximize-score-after-n-operations.py)
- 1937.[扣分后的最大得分](medium/1937-maximum-number-of-points-with-cost.py)
- 1959.[K 次调整数组大小浪费的最小总空间](medium/1959-minimum-total-space-wasted-with-k-resizing-operations.py)
- 1981.[最小化目标值与所选元素的差](medium/1981-minimize-the-difference-between-target-and-chosen-elements.py)
- 1994.[好子集的数目](hard/1994-the-number-of-good-subsets.py)
- 1997.[访问完所有房间的第一天](medium/1997-first-day-where-you-have-been-in-all-the-rooms.py)
- 2008.[出租车的最大盈利](medium/2008-maximum-earnings-from-taxi.py)
- 2019.[解出数学表达式的学生分数](hard/2019-the-score-of-students-solving-math-expression.py)
- 2140.[解决智力问题](medium/2140-solving-questions-with-brainpower.py)
...
- 2435.[矩阵中和能被 K 整除的路径](hard/2435-paths-in-matrix-whose-sum-is-divisible-by-k.py)
- 2447.[最大公因数等于 K 的子数组数目](medium/2447-number-of-subarrays-with-gcd-equal-to-k.py)
- 2463.[最小移动总距离](hard/2463-minimum-total-distance-traveled.py)
- 2466.[统计构造好字符串的方案数](medium/2466-count-ways-to-build-good-strings.py)
- 2470.[最小公倍数为 K 的子数组数目](medium/2470-number-of-subarrays-with-lcm-equal-to-k.py)
- 2472.[不重叠回文子字符串的最大数目](hard/2472-maximum-number-of-non-overlapping-palindrome-substrings.py)
- 2478.[完美分割的方案数](hard/2478-number-of-beautiful-partitions.py)
- 面试题 08.01.[三步问题](interview/08.01.three-steps-problem-lcci.py)
- 面试题 08.13.[堆箱子](interview/08.13.pile-box-lcci.py)
- 面试题 17.09.[第 k 个数](interview/17.09.get-kth-magic-number-lcci.py)
...
- 1079.[活字印刷](medium/1079-letter-tile-possibilities.py)
...
- 1947.[最大兼容性评分和](medium/1947-maximum-compatibility-score-sum.py)
...
- 255.[验证前序遍历序列二叉搜索树](vip/medium/255-verify-preorder-sequence-in-binary-search-tree.py)
...
- 381.[O(1) 时间插入、删除和获取随机元素 - 允许重复](hard/381-insert-delete-getrandom-o1-duplicates-allowed.py)
...
- 2069.[模拟行走机器人 II](medium/2069-walking-robot-simulation-ii.py)
...
- 2502.[设计内存分配器](medium/2502-design-memory-allocator.py)
...
- 754.[到达终点数字](medium/754-reach-a-number.py)
...
- 2063.[所有子字符串中的元音](medium/2063-vowels-of-all-substrings.py)
- 2110.[股票平滑下跌阶段的数目](medium/2110-number-of-smooth-descent-periods-of-a-stock.py)
...
- 2457.[美丽整数的最小增量](medium/2457-minimum-addition-to-make-integer-beautiful.py)
...
- 963.[最小面积矩形 II](medium/963-minimum-area-rectangle-ii.py)
...
- 1662.[检查两个字符串数组是否相等](easy/1662-check-if-two-string-arrays-are-equivalent.py)
...
- 721.[账户合并](medium/721-accounts-merge.py)
...
- 1971.[寻找图中是否存在路径](easy/1971-find-if-path-exists-in-graph.py)
...
- 2424.[最长上传前缀](medium/2424-longest-uploaded-prefix.py)
...
- 1774.[最接近目标价格的甜点成本](medium/1774-closest-dessert-cost.py)
- 2002.[两个回文子序列长度的最大乘积](medium/2002-maximum-product-of-the-length-of-two-palindromic-subsequences.py)
...
- 2443.[反转之后的数字和](medium/2443-sum-of-number-and-its-reverse.py)
...
- 1888.[使二进制字符串字符交替的最少反转次数](medium/1888-minimum-number-of-flips-to-make-the-binary-string-alternating.py)
